document.addEventListener("DOMContentLoaded", () => {
    ...
    // **Interatividade do Infográfico Completo**
    const openModalBtn = document.getElementById("open-full-infografico");
    const modal = document.getElementById("modal-full-infografico");
